...
const Forum = () => {
  ...
  return (
    <div className="mx-5 mt-3 flex flex-col gap-10 pb-20">
      {/* header and button */}
        ...
        {discussions.map((item, idx) => {
          ...
          return (
            <Link
              key={idx}
              to={`/forum/${item.id}`}
              className="flex cursor-pointer items-center justify-between rounded-lg bg-blue-50 p-3 px-5 hover:bg-blue-100"
            >
